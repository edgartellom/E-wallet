    ...
    <div className="d-block text-center">
      ...
      <div className="table table-responsive table-sm mx-auto">
        <table className="table table-sm table-hover bg-light">
          <thead>
            <tr>
              <th scope="col" className="col-1 text-center small fw-bold">
                ID
              </th>
              <th scope="col" className="col-2  fw-bold">
                Imagen
              </th>
              <th scope="col" className="col-2  fw-bold">
                Name
              ...
              <th scope="col" className="col-1  fw-bold">
                Price
              </th>
              <th scope="col" className="col-3  fw-bold">
                Action
              </th>
            </tr>
          </thead>
