...
const Login = () => {
    ...
    return (
        ...
        <div>
            {
                user !== null ? (<button type="button" className="btn btn-outline-dark"
                    data-bs-toggle="modal" data-bs-target="#logout" onClick={handleSignOut}>Logout</button>) :
                    (<div>
                        <ul>
                            <button type="button" className="btn btn-outline-dark"
                                data-bs-toggle="modal" data-bs-target="#signinModal">Signin</button>
                        </ul>
                        <ul>
                            <button type="button" className="btn btn-outline-dark"
                                    ...
                                    <div className="modal-body">
                                        ...
                                        <form onSubmit={handleSubmit} id="login-form">
                                            ...
                                            <div className="d-grid gap-2">
                                                ...
                                                <button className="btn btn-primary" type="button" onClick={handleOnClick}> Login with Google</button>
                                            </div>
