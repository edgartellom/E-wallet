        ...
        <div className="col-12">
          <form
            ...
            <textarea
              ...
              placeholder="Would you like to add a comment?"></textarea>
              ...
              <div className="row">
                <div className="col-6">
                  <input
                    ...
                    value="SAVE REVIEW"
                    className="btn-cart btn-outline-success mt-auto w-100"></input>
                </div>
                <div className="col-6">
                  <input
                    type="button"
                    ...
                    className="btn-cart btn-outline-danger mt-auto w-100"></input>
                </div>
              </div>
            </div>
          </form>
